...
class WallpaperChangerGUI(ctk.CTk):
    ...
    def __init__(self):
        ...
        # Start minimized to tray and auto-start wallpaper changer
    ...
    def _auto_start(self):
        """Automatically start the wallpaper changer if a folder is configured"""
        if self.folder_path.get() and os.path.isdir(self.folder_path.get()):
            self.start_changer()

    def _startup_sequence(self):
        """Start minimized to tray and auto-start wallpaper changer"""
        # Minimize to tray first
        self.minimize_to_tray()
        # Then auto-start if folder is configured
        self._auto_start()
